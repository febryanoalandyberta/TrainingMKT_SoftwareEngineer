        ...
        return `
            ...
            <div class="container">
                ...
                <div class="slider-container" id="slider-container">
                    <div class="slider-text">Geser ke kanan untuk Selesai</div>
    ...
    execute() {
        ...
        const performSubmit = async () => {
            ...
            try {
                ...
                const response = await AttendanceAPI.submit('Selesai Istirahat', data);

                if (response.success) {
                    sliderContainer.classList.remove('loading');
                    sliderContainer.classList.add('success');
                    setTimeout(() => {
                        alert('✅ Berhasil Selesai Istirahat!');
                        window.history.back();
                    }, 500);
                } else {
