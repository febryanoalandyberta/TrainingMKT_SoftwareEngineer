...
export default class extends AbstractView {
    constructor() {
        super();
        this.setTitle("Break Out - PT Mega Kreasi Tech");
    }
        ...
        return `
            ...
            <div class="container">
                <div style="display: flex; align-items: center; margin-bottom: 20px;">
                    ...
                    <h2 style="font-size: 1.3rem; margin: 0;">Break Out</h2>
                </div>

                <div class="clock-display">
                    <div class="time-big" id="live-clock">13:00:00</div>
                </div>
                ...
                <div class="camera-frame">
                     ...
                     <div class="camera-overlay">
                        <div id="overlay-time">12 OKT 2023 13:00:05 - JAKARTA SELATAN</div>
                     </div>
                </div>
    ...
    execute() {
        ...
        setInterval(() => {
            ...
            // Note: Overlay text is hardcoded in prototype, but could be dynamic
        }, 1000);
    }
}
